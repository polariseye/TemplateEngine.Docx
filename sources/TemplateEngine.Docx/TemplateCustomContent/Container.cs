...
namespace TemplateEngine.Docx
{
    ...
    public abstract class Container : IEnumerable<IContentItem>, IEquatable<Container>
    {
        protected Container()
        {
            ...
            CheckBox = new List<CheckBoxContent>();
        ...
        protected Container(params IContentItem[] contentItems)
        {
            if (contentItems != null)
            {
                ...
                CheckBox = contentItems.OfType<CheckBoxContent>().ToList();
            }
        }
        ...
        protected IEnumerable<IContentItem> All
        {
            get
            {
                ...
                if (CheckBox != null) result = result.Concat(CheckBox).ToList();
        ...
        public ICollection<CheckBoxContent> CheckBox { get; set; }
        ...
        public IEnumerable<string> FieldNames
        {
            get
            {
                ...
                var checkBoxFieldNames = CheckBox == null
                    ? new List<string>()
                    : CheckBox.Select(f => f.Name);
        ...
        protected Container AddCheckBox(CheckBoxContent checkBox)
        {
            if (CheckBox == null) CheckBox = new List<CheckBoxContent>();
