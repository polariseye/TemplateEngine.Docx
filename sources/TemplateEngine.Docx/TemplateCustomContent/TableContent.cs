...
namespace TemplateEngine.Docx
{
    ...
    public class TableContent : HiddenContent<TableContent>, IContentItem, IEquatable<TableContent>
    {
        ...
        public List<MergeTableCellContent> MergeCellContent { get; set; } = new List<MergeTableCellContent>();
        ...
        public TableContent AddMergeCell(params MergeTableCellContent[] mergeCellContent)
        {
            this.MergeCellContent.AddRange(mergeCellContent);
            return this;
        }
