...
namespace TemplateEngine.Docx
{
    static class XElementExtensions
    {
        ...
        public static void ReplaceContentControlWithRunElement(this XElement sdt, params XElement[] newValue)
        {
            var sdtContentElement = sdt.Element(W.sdtContent);
            ...
            if (sdtContentElement != null)
            {
                ...
                /*
                 if (sdtContentElement.Elements(W.p).Any())
                {
                    sdtContentElement.Element(W.p).Add(newValue);
                }
                else
                {
                    sdtContentElement.Add(new XElement(W.p), new XElement(W.r, newValue));
                }*/
                sdtContentElement.Add(newValue);
            }
            else
            {
                sdt.Add(newValue);
